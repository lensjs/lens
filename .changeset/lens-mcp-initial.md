...
Add `@lensjs/mcp`, a Model Context Protocol server that gives AI agents read-only access to Lens's captured errors, requests, and queries so they can diagnose issues and propose fixes.
